...
// we are using @Table to rename the table name in database
// because Match is keyword that already exist in java so to avoid problems we are changing the table name @Table
public class Match {
    @Id
